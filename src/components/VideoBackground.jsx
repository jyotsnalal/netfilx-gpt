...
const VideoBackground = ({ movieId }) => {
  ...
  return (
    <div className="absolute inset-0 w-[100vw] h-[100vh] overflow-hidden z-0">
      <iframe
        className="absolute top-0 left-0 w-full h-full object-cover pointer-events-none scale-[1.4]"
